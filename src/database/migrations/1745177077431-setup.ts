...
export class Setup1745177077431 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."animes_status_enum" AS ENUM('Airing', 'Completed', 'Upcoming', 'On Hold', 'Cancelled')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."animes_type_enum" AS ENUM('Show', 'Movie', 'OVA', 'ONA', 'Special')`,
    );
    await queryRunner.query(
      `CREATE TABLE "animes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying(255) NOT NULL, "genres" text array, "description" text, "releaseDate" date, "studio" character varying(255), "status" "public"."animes_status_enum", "type" "public"."animes_type_enum", "trailer" character varying(255), "author" character varying(255), "website" character varying(255), "bannerImage" uuid, "coverImage" uuid, CONSTRAINT "PK_16b5c3f560dac36ec440e340545" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."contributions_status_enum" AS ENUM('pending', 'accepted', 'rejected')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."contributions_datastatus_enum" AS ENUM('Airing', 'Completed', 'Upcoming', 'On Hold', 'Cancelled')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."contributions_datatype_enum" AS ENUM('Show', 'Movie', 'OVA', 'ONA', 'Special')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "pfps" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "data" bytea, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "REL_60385efbab2e77ec06a8035f73" UNIQUE ("userId"), CONSTRAINT "PK_1b59d29aaf2e2c164ea71e09f01" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "media" ADD CONSTRAINT "FK_46a895ee65010e2b94ff317e854" FOREIGN KEY ("authorId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "animes" ADD CONSTRAINT "FK_0fdb653860508ed2263c5dcab7c" FOREIGN KEY ("bannerImage") REFERENCES "media"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "animes" ADD CONSTRAINT "FK_f3a742f83f8f02741b97d5ec74d" FOREIGN KEY ("coverImage") REFERENCES "media"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "contributions" ADD CONSTRAINT "FK_55141bcc2980d26a4870712f3f4" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "contributions" ADD CONSTRAINT "FK_b27b972799b45e217c5d310c75d" FOREIGN KEY ("moderatorId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "contributions" ADD CONSTRAINT "FK_5b1f9b8c026b9e46abfadb3d40b" FOREIGN KEY ("animeId") REFERENCES "animes"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "contributions" ADD CONSTRAINT "FK_bfefaa24a457b2e90141da134d3" FOREIGN KEY ("dataBannerimage") REFERENCES "media"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "contributions" ADD CONSTRAINT "FK_9486f127452830b587e2585146c" FOREIGN KEY ("dataCoverimage") REFERENCES "media"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "keys" ADD CONSTRAINT "FK_d66070b078b2628e8e2138f63e5" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "pfps" ADD CONSTRAINT "FK_60385efbab2e77ec06a8035f733" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "pfps" DROP CONSTRAINT "FK_60385efbab2e77ec06a8035f733"`,
    );
    await queryRunner.query(
      `ALTER TABLE "keys" DROP CONSTRAINT "FK_d66070b078b2628e8e2138f63e5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "contributions" DROP CONSTRAINT "FK_9486f127452830b587e2585146c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "contributions" DROP CONSTRAINT "FK_bfefaa24a457b2e90141da134d3"`,
    );
    await queryRunner.query(
      `ALTER TABLE "contributions" DROP CONSTRAINT "FK_5b1f9b8c026b9e46abfadb3d40b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "contributions" DROP CONSTRAINT "FK_b27b972799b45e217c5d310c75d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "contributions" DROP CONSTRAINT "FK_55141bcc2980d26a4870712f3f4"`,
    );
    await queryRunner.query(
      `ALTER TABLE "animes" DROP CONSTRAINT "FK_f3a742f83f8f02741b97d5ec74d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "animes" DROP CONSTRAINT "FK_0fdb653860508ed2263c5dcab7c"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP TYPE "public"."contributions_datastatus_enum"`,
    );
